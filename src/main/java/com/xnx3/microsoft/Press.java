...
public class Press {
	...
	/**
	 * 按下指定的键一定的时间后放开
	 * @param keyCode 如 {@link Press#A}
	 * @param sleep 延迟时间，单位毫秒
	 */
	 ...
	 * @param downKey 要按住的键  如 {@link Press#A}
	 * @param secondKey 第二个按的键  如 {@link Press#A}
	 */
	...
	/**
	 * 按下某键
	 * @param keyCode 传入按键码  如 {@link Press#A}
	 */
	 ...
	 * @param keyCode 传入按键码,传入的为模拟按键的按键码

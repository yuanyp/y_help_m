...
public class Window {
	...
	public int getForegroundFocus(){
		try {
			return this.active.invoke("GetForegroundFocus").getInt();
		} catch (Exception e) {
			e.printStackTrace();
			log.debug(this, "getForegroundFocus", "异常捕获:"+e.getMessage());
		}
		return 0; 
	}
	...
	public int getForegroundWindow(){
		try {
			return this.active.invoke("GetForegroundWindow").getInt();
		} catch (Exception e) {
			e.printStackTrace();
			log.debug(this, "GetForegroundWindow", "异常捕获:"+e.getMessage());
		}
		return 0; 
	}

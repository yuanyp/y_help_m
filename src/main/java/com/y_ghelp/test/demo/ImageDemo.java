...
public class ImageDemo extends JFrame {
	...
	String sourceImg = "source1.png";
	String searchImg = "search1.png";
		...
		gl_contentPane.setHorizontalGroup(
		    gl_contentPane.createParallelGroup(Alignment.LEADING)
		        ...
		        .addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
		            ...
		            .addGap(59))
		        .addGroup(gl_contentPane.createSequentialGroup()
		            .addComponent(btnNewButton_1, GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
		            .addGap(238))
		);
	...
	public void imageSearchBySource(){
		...
		List<CoordBean> list = robot.imageSearch(robot.getResourceImage(sourceImg), robot.getResourceImage(searchImg), Robot.SIM_ACCURATE);
	...
	public void imageSearchByScreen(){
		Robot robot = new Robot();
		robot.setSourcePath(ImageDemo.class);
		List<CoordBean> list = robot.imageSearch(0, 0, robot.screenWidth, robot.screenHeight, searchImg, Robot.SIM_ACCURATE);
	...
	public void imageSearchAndMouseRightClick(){
		Robot robot = new Robot();
		robot.setSourcePath(ImageDemo.class);
		robot.imageDelaySearch(0, 0, 800, 600, robot.getResourceImage(searchImg), Robot.SIM_ACCURATE, 10000);
		List<CoordBean> list = robot.imageSearch(0, 0, robot.screenWidth, robot.screenHeight, searchImg, Robot.SIM_ACCURATE);
